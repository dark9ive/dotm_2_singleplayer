...
tellraw @a[tag=show_skill,distance=..16] [{"selector":"@s","bold":true,"color":"red"},{"text":" 施展了 ","bold":true,"color":"gray"},{"text":"治癒","color":"dark_purple","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"回復 8 公尺內所有友軍 8 點血量","bold":true}]}}},{"text":"(Lv:5)","color":"aqua","bold":false}]
scoreboard players set @s heal_cd -200
scoreboard players remove @s magic_power 640
