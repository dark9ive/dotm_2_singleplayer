...
scoreboard players operation @p[tag=tmp_damage] register *= #75 constant
scoreboard players operation @p[tag=tmp_damage] register /= #100 constant
execute store result score @p[tag=tmp_damage] register run scoreboard players add @p[tag=tmp_damage] register 160
