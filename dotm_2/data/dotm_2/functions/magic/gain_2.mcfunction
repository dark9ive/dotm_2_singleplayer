...
scoreboard players add @a[gamemode=adventure,distance=..8] atk_buff_pa 20
scoreboard players add @s atk_buff_pa 20
...
tellraw @a[tag=show_skill,distance=..16] [{"selector":"@s","bold":true,"color":"red"},{"text":" 施展了 ","bold":true,"color":"gray"},{"text":"強化","color":"dark_purple","bold":true,"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"給予 8 公尺內所有友軍 3 分鐘夜視效果，並提升自身 40 % 攻擊力，8 公尺內所有友軍 20 % 攻擊力，持續 30 秒","bold":true}]}}},{"text":"(Lv:2)","color":"aqua","bold":false}]
