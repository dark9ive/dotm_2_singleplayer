...
data modify block ~ ~ ~ Items[{Slot:4b}].id set value "minecraft:iron_pickaxe"
data modify block ~ ~ ~ Items[{Slot:4b}].tag set value {canfix:1,CanDestroy:["minecraft:smooth_stone","minecraft:coal_ore","minecraft:iron_ore","minecraft:diamond_ore"],HideFlags:63,display:{Name:'[{"text":"","italic":false},{"text":"料峭牌稀有鎬","color":"dark_gray","bold":true}]',Lore:['[{"text":"","italic":false},{"text":"★ ★ ★","color":"gold","bold":true}]','[{"text":"","italic":false}]','[{"text":"","italic":false},{"text":"來自","color":"gray"},{"text":"料峭北城","color":"dark_green"},{"text":"的優質鎬子","color":"gray"}]','[{"text":"","italic":false},{"text":"可以用來挖掘礦石","color":"gray"}]','[{"text":"","italic":false}]','[{"text":"","italic":false}]','[{"text":"","italic":false},{"text":"取得方式 : ","color":"red","bold":true},{"text":"合成台升級","color":"gray"}]','[{"text":"","italic":false},{"text":"適用職業 : ","color":"red","bold":true},{"text":"所有職業","color":"gray"}]']}}
