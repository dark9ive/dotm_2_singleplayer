...
scoreboard players operation @s material_3_1 -= #material register
...
scoreboard players operation #system register *= #4 constant
scoreboard players set #health register 12
