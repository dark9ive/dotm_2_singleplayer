...
scoreboard players operation @s material_5_4 -= #material register
scoreboard players add #star register 1
scoreboard players operation #system register = #level register
scoreboard players operation #system register *= #3 constant
scoreboard players operation #system register *= #5 constant
scoreboard players operation #system register *= #10 constant
scoreboard players set #health register 100
...
execute store result block ~ ~ ~ Items[{Slot:4b}].tag.Parameter[{"name":"health_value"}].value int 1 run scoreboard players get #health register
...
data modify block ~ ~ ~ Items[{Slot:4b}].tag.display.Lore[4] set from block 7 2 -8 Text3
