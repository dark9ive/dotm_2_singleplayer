execute unless data entity @s Inventory[{id:"minecraft:phantom_membrane",tag:{CustomModelData:41}}] run tellraw @s [{"text":"你身上沒有 10 元 !","color":"gray","bold":false}]
execute if data entity @s Inventory[{id:"minecraft:phantom_membrane",tag:{CustomModelData:41}}] run scoreboard players add @s money 10
execute if data entity @s Inventory[{id:"minecraft:phantom_membrane",tag:{CustomModelData:41}}] run clear @s minecraft:phantom_membrane{CustomModelData:41} 1
