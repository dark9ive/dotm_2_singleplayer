...
execute if data entity @s Inventory[{id:"minecraft:phantom_membrane",tag:{CustomModelData:42}}] run scoreboard players add @s money 100
execute if data entity @s Inventory[{id:"minecraft:phantom_membrane",tag:{CustomModelData:42}}] run clear @s minecraft:phantom_membrane{CustomModelData:42} 1
