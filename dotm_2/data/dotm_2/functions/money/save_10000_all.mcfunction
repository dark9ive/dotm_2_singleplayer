...
execute store result score #money register run clear @s minecraft:phantom_membrane{CustomModelData:44}
scoreboard players operation #money register *= #10000 constant
