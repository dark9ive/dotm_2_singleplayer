...
execute store result score #money register run clear @s minecraft:phantom_membrane{CustomModelData:41}
scoreboard players operation #money register *= #10 constant
