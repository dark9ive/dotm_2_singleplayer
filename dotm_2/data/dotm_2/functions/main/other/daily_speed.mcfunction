execute if score #daily_speed register matches 1..4 run scoreboard players add #daily_speed register 1
execute unless score #daily_speed register matches 1..4 run scoreboard players set #daily_speed register 1
...
execute if score #daily_speed register matches 4 run data modify block -203 189 269 Text4 set value '{"text":"1分鐘","color":"green","bold":true}'
