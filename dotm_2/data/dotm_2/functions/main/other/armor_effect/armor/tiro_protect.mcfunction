...
execute store result entity @e[tag=value_calculate_boots,limit=1] ArmorItems[0].tag.Enchantments[{id:"minecraft:protection"}].lvl int 1 run scoreboard players get #system register
loot replace entity @s armor.feet kill @e[limit=1,tag=value_calculate_boots]
tag @s add skill_1001
