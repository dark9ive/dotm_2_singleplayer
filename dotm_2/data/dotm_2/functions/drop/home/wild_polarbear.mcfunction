tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"野生北極熊","color":"green","bold":true},{"text":" !","color":"gray"}]
scoreboard players add @s pay_exp_hp 18
scoreboard players add @s pay_exp_atk 2
scoreboard players add @s pay_money_hp 18
...
advancement revoke @s only dotm_2:drop/home/wild_polarbear
