tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"高階魔人","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_hp 15000
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_atk 12
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_hp 15000
...
advancement revoke @s only dotm_2:drop/boss_town_under/monster_high
