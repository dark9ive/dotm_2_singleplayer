tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"嗜血蛀蟲","color":"yellow","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/boss_town_under/aphids
...
execute if score @s level matches 3600.. run function dotm_2:drop/equipment/rare/dwngon
