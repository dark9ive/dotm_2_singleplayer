tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"中階魔人","color":"yellow","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_hp 9000
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_atk 10
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_hp 9000
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_atk 10
...
advancement revoke @s only dotm_2:drop/boss_town_under/monster_mid
...
execute if score @s level matches 3600.. run function dotm_2:drop/equipment/rare/audi
