tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"低階魔人","color":"green","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_hp 4500
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_atk 8
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_hp 4500
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_atk 8
...
advancement revoke @s only dotm_2:drop/boss_town_under/monster_low
