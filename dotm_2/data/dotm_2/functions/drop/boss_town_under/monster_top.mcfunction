tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"頂階魔人","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_hp 22000
execute if score @s level matches 3600.. run scoreboard players add @s pay_exp_atk 15
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_hp 22000
execute if score @s level matches 3600.. run scoreboard players add @s pay_money_atk 15
...
advancement revoke @s only dotm_2:drop/boss_town_under/monster_top
