tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"剎剎啞","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 6300.. run scoreboard players add @s pay_exp_hp 90000
execute if score @s level matches 6300.. run scoreboard players add @s pay_exp_atk 36
execute if score @s level matches 6300.. run scoreboard players add @s pay_money_hp 90000
execute if score @s level matches 6300.. run scoreboard players add @s pay_money_atk 36
...
advancement revoke @s only dotm_2:drop/monster_boss/chachaya
...
execute if score @s level matches 6300.. if score @s item_buff matches ..0 run function dotm_2:main/other/random
execute if score @s level matches 6300.. if score @s item_buff matches ..0 if score #system random <= #system material_5_1 run scoreboard players add @s material_5_1 1
execute if score @s level matches 6300.. run function dotm_2:drop/equipment/legend/batuan
