tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"魔騎獸","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 6300.. run scoreboard players add @s pay_exp_hp 80000
execute if score @s level matches 6300.. run scoreboard players add @s pay_exp_atk 32
execute if score @s level matches 6300.. run scoreboard players add @s pay_money_hp 80000
execute if score @s level matches 6300.. run scoreboard players add @s pay_money_atk 32
...
advancement revoke @s only dotm_2:drop/monster_boss/monster_ride
