tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"死靈狙擊手","color":"green","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 300.. run scoreboard players add @s pay_exp_hp 240
execute if score @s level matches 300.. run scoreboard players add @s pay_exp_atk 4
execute if score @s level matches 300.. run scoreboard players add @s pay_money_hp 240
...
advancement revoke @s only dotm_2:drop/desert_village/dye_soul_shooter
