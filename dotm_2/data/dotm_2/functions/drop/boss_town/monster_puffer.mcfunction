tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"魔化河豚","color":"green","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 2800.. run scoreboard players add @s pay_exp_hp 3200
execute if score @s level matches 2800.. run scoreboard players add @s pay_exp_atk 8
execute if score @s level matches 2800.. run scoreboard players add @s pay_money_hp 3200
...
advancement revoke @s only dotm_2:drop/boss_town/monster_puffer
...
execute if score @s level matches 2800.. if score @s item_buff matches ..0 run function dotm_2:main/other/random
execute if score @s level matches 2800.. if score @s item_buff matches ..0 if score #system random <= #system material_3_3 run scoreboard players add @s material_3_3 1
execute if score @s level matches 2800.. run function dotm_2:drop/equipment/rare/longchan
function dotm_2:main/other/pay_money
scoreboard players add #water_element_power register 1
tellraw @s [{"text":"水元素庫存量 + 1 !","color":"aqua"}]
