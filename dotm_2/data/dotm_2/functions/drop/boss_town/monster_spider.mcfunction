tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"魔化毒蛛","color":"yellow","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 2800.. run scoreboard players add @s pay_exp_hp 6000
execute if score @s level matches 2800.. run scoreboard players add @s pay_exp_atk 10
execute if score @s level matches 2800.. run scoreboard players add @s pay_money_hp 6000
...
advancement revoke @s only dotm_2:drop/boss_town/monster_spider
