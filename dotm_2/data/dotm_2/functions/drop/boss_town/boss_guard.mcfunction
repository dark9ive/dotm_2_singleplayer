tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"魔王城侍衛","color":"green","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/boss_town/boss_guard
...
execute if score @s level matches 2800.. run function dotm_2:drop/equipment/rare/bronze
