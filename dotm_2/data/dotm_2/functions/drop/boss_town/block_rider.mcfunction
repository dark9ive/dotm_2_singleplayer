tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"方塊座騎","color":"green","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/boss_town/block_rider
