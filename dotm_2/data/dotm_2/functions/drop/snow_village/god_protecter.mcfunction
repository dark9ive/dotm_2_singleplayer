tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"護神魔象","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 1500.. run scoreboard players add @s pay_exp_hp 6000
execute if score @s level matches 1500.. run scoreboard players add @s pay_exp_atk 12
execute if score @s level matches 1500.. run scoreboard players add @s pay_money_hp 6000
...
advancement revoke @s only dotm_2:drop/snow_village/god_protecter
...
execute if score @s level matches 1500.. if score @s item_buff matches ..0 run function dotm_2:main/other/random
execute if score @s level matches 1500.. if score @s item_buff matches ..0 if score #system random <= #system material_3_1 run scoreboard players add @s material_3_1 1
execute if score @s level matches 1500.. run function dotm_2:drop/equipment/high/yafun
