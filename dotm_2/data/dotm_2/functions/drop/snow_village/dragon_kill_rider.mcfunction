tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"弒龍騎士","color":"red","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/snow_village/dragon_kill_rider
