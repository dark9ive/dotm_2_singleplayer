tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"星炎坐騎","color":"red","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 1500.. run scoreboard players add @s pay_exp_hp 7500
execute if score @s level matches 1500.. run scoreboard players add @s pay_exp_atk 10
execute if score @s level matches 1500.. run scoreboard players add @s pay_money_hp 7500
execute if score @s level matches 1500.. run scoreboard players add @s pay_money_atk 10
...
advancement revoke @s only dotm_2:drop/snow_village/star_flame_ride
