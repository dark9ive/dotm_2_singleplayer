tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"熱帶河豚","color":"yellow","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 2100.. run scoreboard players add @s pay_exp_hp 4000
execute if score @s level matches 2100.. run scoreboard players add @s pay_exp_atk 12
execute if score @s level matches 2100.. run scoreboard players add @s pay_money_hp 4000
...
advancement revoke @s only dotm_2:drop/sea_town/tropic_fish
