tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"海底護衛者","color":"green","bold":true},{"text":" !","color":"gray"}]
advancement revoke @s only dotm_2:drop/sea_town/undersea_guard
