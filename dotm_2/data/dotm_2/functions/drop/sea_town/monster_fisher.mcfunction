tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"魔化漁夫","color":"green","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 2100.. run scoreboard players add @s pay_exp_hp 2000
execute if score @s level matches 2100.. run scoreboard players add @s pay_exp_atk 7
execute if score @s level matches 2100.. run scoreboard players add @s pay_money_hp 2000
...
advancement revoke @s only dotm_2:drop/sea_town/monster_fisher
