tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"海底詠唱者長老","color":"dark_red","bold":true},{"text":" !","color":"gray"}]
advancement revoke @s only dotm_2:drop/sea_town/undersea_mage_elder
