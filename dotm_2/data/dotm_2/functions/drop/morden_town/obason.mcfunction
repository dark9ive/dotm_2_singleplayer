tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"打掃廁所的歐巴桑","color":"green","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/morden_town/obason
