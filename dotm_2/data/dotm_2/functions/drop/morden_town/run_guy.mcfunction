tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"跑腿小弟","color":"green","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 100.. run scoreboard players add @s pay_exp_hp 90
execute if score @s level matches 100.. run scoreboard players add @s pay_exp_atk 3
execute if score @s level matches 100.. run scoreboard players add @s pay_money_hp 90
...
advancement revoke @s only dotm_2:drop/morden_town/run_guy
