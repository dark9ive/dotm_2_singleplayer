tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"經理","color":"yellow","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/morden_town/manager
...
execute if score @s level matches 100.. as @a[distance=..16,tag=task_101] if entity @s[scores={task_101=50..}] run scoreboard players add @s pay_money_task 2
