tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"工作狂","color":"green","bold":true},{"text":" !","color":"gray"}]
...
advancement revoke @s only dotm_2:drop/morden_town/working_guy
