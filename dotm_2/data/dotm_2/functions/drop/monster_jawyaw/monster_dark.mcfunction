tellraw @s[tag=show_kill] [{"text":"已擊殺 ","color":"gray"},{"text":"暗襲狂魔","color":"yellow","bold":true},{"text":" !","color":"gray"}]
execute if score @s level matches 5400.. run scoreboard players add @s pay_exp_hp 20000
execute if score @s level matches 5400.. run scoreboard players add @s pay_exp_atk 16
execute if score @s level matches 5400.. run scoreboard players add @s pay_money_hp 20000
execute if score @s level matches 5400.. run scoreboard players add @s pay_money_atk 16
...
advancement revoke @s only dotm_2:drop/monster_jawyaw/monster_dark
...
execute if score @s level matches 5400.. if score @s item_buff matches ..0 run function dotm_2:main/other/random
execute if score @s level matches 5400.. if score @s item_buff matches ..0 if score #system random <= #system material_4_3 run scoreboard players add @s material_4_3 1
execute if score @s level matches 5400.. run function dotm_2:drop/equipment/legend/swanjan
